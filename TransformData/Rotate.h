...
private:
    ...
    double z0;
public:
    Rotate() : arc_x(0.0), arc_y(0.0), arc_z(0.0), x0(0), y0(0), z0(0) {}
    Rotate(double x, double y, double z, double _x0 = 0, double _y0 = 0, double _z0 = 0)
        : arc_x(x), arc_y(y), arc_z(z), x0(_x0), y0(_y0), z0(_z0) {}
    Rotate(const Rotate&);
    ~Rotate() {}
